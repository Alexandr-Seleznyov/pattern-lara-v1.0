...
export default {
  ...
  data: function () {
    return {
      ...
      tableItems: [
        {
          avatar: { url: 'img/backend/demo/avatars/1.jpg', status: 'success' },
        ...
        {
          avatar: { url: 'img/backend/demo/avatars/2.jpg', status: 'danger' },
        ...
        {
          avatar: { url: 'img/backend/demo/avatars/3.jpg', status: 'warning' },
        ...
        {
          avatar: { url: 'img/backend/demo/avatars/4.jpg', status: '' },
        ...
        {
          avatar: { url: 'img/backend/demo/avatars/5.jpg', status: 'success' },
        ...
        {
          avatar: { url: 'img/backend/demo/avatars/6.jpg', status: 'danger' },
